...
class RobotApi(object):
    ...
    def add_robot_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'robot_contamination' in params:
            form_params.append(('robotContamination', params['robot_contamination']))  # noqa: E501
    ...
    def add_robot(self, id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs):  # noqa: E501
        """Добавить робота  # noqa: E501

        Добавить робота в базу  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_robot(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, async_req=True)
        >>> result = thread.get()
        ...
        :param int robot_contamination: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs)  # noqa: E501
        else:
            (data) = self.add_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs)  # noqa: E501
            return data

    def add_robot_with_http_info(self, id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs):  # noqa: E501
        """Добавить робота  # noqa: E501

        Добавить робота в базу  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'model', 'version', 'charge', 'garbage_container', 'robot_contamination', 'next_service', 'serial_number', 'ip_address', 'group_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'robot_contamination' is set
        if ('robot_contamination' not in params or
                params['robot_contamination'] is None):
            raise ValueError("Missing the required parameter `robot_contamination` when calling `add_robot`")  # noqa: E501
    ...
    def update_robot(self, id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs):  # noqa: E501
        """Обновить робота  # noqa: E501

        Обновить робота  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_robot(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs)  # noqa: E501
            return data

    def update_robot_with_http_info(self, id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, **kwargs):  # noqa: E501
        """Обновить робота  # noqa: E501

        Обновить робота  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_robot_with_http_info(id, model, version, charge, garbage_container, robot_contamination, next_service, serial_number, ip_address, group_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('robot_contamination' not in params or
                params['robot_contamination'] is None):
            raise ValueError("Missing the required parameter `robot_contamination` when calling `update_robot`")  # noqa: E501
        # verify the required parameter 'next_service' is set
        if ('next_service' not in params or
                params['next_service'] is None):
