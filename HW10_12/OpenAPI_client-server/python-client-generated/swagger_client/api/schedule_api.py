...
class ScheduleApi(object):
    ...
    def delete_schedule_by_id(self, schedule_id, **kwargs):  # noqa: E501
        """Удалить расписание по ID  # noqa: E501
    ...
    def get_schedule_by_id(self, schedule_id, **kwargs):  # noqa: E501
        """Найти расписание по ID  # noqa: E501

        вернуть одно расписание  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schedule_by_id(schedule_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int schedule_id: Идентификатор расписания (required)
        :return: Schedule
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_schedule_by_id_with_http_info(schedule_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_schedule_by_id_with_http_info(schedule_id, **kwargs)  # noqa: E501
            return data

    def get_schedule_by_id_with_http_info(self, schedule_id, **kwargs):  # noqa: E501
        """Найти расписание по ID  # noqa: E501

        вернуть одно расписание  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schedule_by_id_with_http_info(schedule_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('schedule_id' not in params or
                params['schedule_id'] is None):
            raise ValueError("Missing the required parameter `schedule_id` when calling `get_schedule_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Schedule/findById/{scheduleId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
