...
class Robot(Model):
    ...
    """
    def __init__(self, id: int=None, model: str=None, version: str=None, charge: int=None, garbage_container: int=None, robot_contamination: int=None, next_service: int=None, serial_number: str=None, ip_address: int=None, group_id: int=None):  # noqa: E501
        ...
        :param robot_contamination: The robot_contamination of this Robot.  # noqa: E501
        ...
        self.attribute_map = {
            ...
            'robot_contamination': 'robotContamination',
        ...
        self._robot_contamination = robot_contamination
    ...
    @property
    def robot_contamination(self) -> int:
        """Gets the robot_contamination of this Robot.


        :return: The robot_contamination of this Robot.
        :rtype: int
        """
        return self._robot_contamination

    @robot_contamination.setter
    def robot_contamination(self, robot_contamination: int):
        """Sets the robot_contamination of this Robot.


        :param robot_contamination: The robot_contamination of this Robot.
        :type robot_contamination: int
        """
        if robot_contamination is None:
            raise ValueError("Invalid value for `robot_contamination`, must not be `None`")  # noqa: E501
